        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.featuresGrid}>
                    ...
                    <TouchableOpacity style={styles.featureCard}>
                        <View style={styles.iconCircle}><Ionicons name="card" size={28} color="#333" /></View>
                    ...
                    <TouchableOpacity style={styles.featureCard}>
                        <View style={styles.iconCircle}><Ionicons name="calendar" size={28} color="#333" /></View>
                ...
                <View style={styles.recommendCard}><Text style={styles.recommendText}>Check your upcoming exams</Text></View>
                <View style={styles.recommendCard}><Text style={styles.recommendText}>Submit pending assignments</Text></View>
            </ScrollView>
        </View>
    );
}
